...
class QuizInterface:
    ...
    def __init__(self, quiz: QuizBrain):
        ...
        self.correct_button = Button(image=correct_image, highlightthickness=0, command=self.tick_clicked)
        self.correct_button.grid(row=2, column=0)

        incorrect_image = PhotoImage(file="images/false.png")
        self.incorrect_button = Button(image=incorrect_image, highlightthickness=0, command=self.cross_clicked)
